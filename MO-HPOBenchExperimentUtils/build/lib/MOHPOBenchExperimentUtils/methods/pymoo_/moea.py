...
class Pymoo_MOEA_D(Pymoo_Optimizer):
    ...
    def __init__(self, optimizer_settings: Dict, benchmark_settings: Dict,
        ...
        super(Pymoo_MOEA_D, self).__init__(
    ...
    def init(self):
        ...
        crossover = MixedVariableCrossover(parameter_types, {
            "real": get_crossover("real_sbx", prob=1.0, eta=20),
            "int": get_crossover("int_sbx", prob=1.0, eta=20)
        })
        ...
        self.algorithm = MOEAD(
            ...
            n_neighbors=self.optimizer_settings['n_neighbors'],
            decomposition=self.optimizer_settings['decomposition'],
            prob_neighbor_mating=self.optimizer_settings['prob_neighbor_mating'],
